...
public class Champion extends Unit{
    ...
    public Champion(int mana, String name, String[] keywords, RegionT region, RarityT rarity, int power, int health, SubT subtype, String levelCond, Champion level, Spell spell, int duplicates){
        super(mana, name, keywords, region, rarity, power, health, CardT.Champion, subtype, duplicates);
